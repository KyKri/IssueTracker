...
/******/ 	// eslint-disable-next-line no-unused-vars
/******/ 	var hotCurrentHash = "6eedfac72d5a16fbd91d";
...
source_map_support__WEBPACK_IMPORTED_MODULE_4___default.a.install(); // Variables
...
app.get('*', (req, res) => {
  res.sendFile(path__WEBPACK_IMPORTED_MODULE_3___default.a.resolve('public/index.html'));
});
app.listen(port, () => {
